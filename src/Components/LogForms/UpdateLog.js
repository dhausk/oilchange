    ...
    return (
      <div className="Update-log">
        ...
        <form className="form" onSubmit={(event) => this.props.formSubmit(event, this.state, )}>
          ...
          <input type="text" name="maintenance" onChange={this.changeHandler} defaultValue={this.state.maintenance} required ></input>
          <label name="cost">how much did this cost?</label>
          <input type="text" name="cost" onChange={this.changeHandler} defaultValue={this.state.cost} required ></input>
          <label name="date">When did this maintenance occur?</label>
          <input type="date" name="date" onChange={this.changeHandler} defaultValue={this.state.date} required ></input>
